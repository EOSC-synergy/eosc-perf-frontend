...
const TermsOfService: FC = () => (
    <>
        ...
        <p>This policy for the EOSC benchmark collection service is valid as of October 2021.</p>
        <p>
            This Acceptable Use Policy and Conditions of Use (“AUP”) defines the rules and
            conditions that govern your access to and use (including transmission, processing, and
            storage of data) of the resources and services (“Services”) as granted by the department{' '}
        ...
        <ol>
            <li>
                ...
                including by not causing harm to the Services; you have an obligation to collaborate
                in the resolution of issues arising from your use of the Services.
            </li>
            <li>
            ...
            <li>You shall respect intellectual property and confidentiality agreements, e.g.:</li>
            <ol type="a">
                <li>
                    You are solely responsible for the content of, and for any harm resulting from,
                    any content created or uploaded by you (&quot;Content&quot;) to the Services.
                </li>
                <li>
                    You agree that you will only submit Content that you have the right to post; and
                    that you will fully comply with any third party licenses relating to Content you
                    post.
                </li>
                <li>Any Content you post publicly may be viewed by others.</li>
                <li>
                    You grant us and our legal successors the right to store, archive, parse, and
                    display Your Content, and make incidental copies, as necessary to provide the
                    Service, including improving the Service over time.
                </li>
                <li>
                    We have the right to refuse or remove any Content that, in our sole discretion,
                    violates any laws or our Privacy policy.
                </li>
            </ol>
            <li>
            ...
            <li>
                ...
                service level agreements listed below. Use without such agreements is at your own
                risk.
            </li>
            <li>
