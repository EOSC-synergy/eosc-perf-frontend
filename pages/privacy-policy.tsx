...
const PrivacyPolicy: NextPage = () => (
    <>
        ...
        <Container>
            ...
            This privacy policy for the EOSC benchmark collection service is valid as of September
            2020.
            <h2>Service</h2>
            The EOSC benchmark collection service (in the following referred to as the Service)
            allows users to collect, share, compare and download benchmark results for the European
            ...
            <h2>Personal data</h2>
            The Service collects three categories of personally identifiable data (in the following
            collectively the Personal Data):
            <br />
            A. Personal data retrieved from your Home Organisation:
            <ul>
                <li>
                    Your unique user identifier (provided by the EGI Check-In system) if you have
                    signed in
                </li>
            ...
            performance evaluation. Your mail address and full name are stored for the purpose of
            handling reports you file and attributing results you upload.
            ...
            Uploader information associated with user-provided content is retained indefinitely and
            only deleted at user request. Note that IP data is stored inside log files for
